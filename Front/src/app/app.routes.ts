...
import { TitlesComponent } from './features/titles/titles.component';

export const routes: Routes = [
  { path: '', component: LandingComponent },
  { path: 'login', component: LoginComponent },
  { path: 'register', component: RegisterComponent },
  { path: 'learning', redirectTo: 'learning/user/trainings', pathMatch: 'full' },
  { path: 'learning/user/trainings', component: TrainingComponent, data: { accessRole: 'USER' } },
  { path: 'learning/admin/trainings', component: TrainingComponent, data: { accessRole: 'ADMIN' } },
  { path: 'learning/user/certifications', component: CertificationComponent, data: { accessRole: 'USER' } },
  { path: 'learning/admin/certifications', component: CertificationComponent, data: { accessRole: 'ADMIN' } },
  { path: 'learning/user/titles', component: TitlesComponent },
  // Client routes
