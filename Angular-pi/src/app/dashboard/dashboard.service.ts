  ...
  private charts: ApexOptions[] = [
    {
      ...
      stroke: { curve: 'smooth' },
      series: [
        { name: 'UV', data: [31, 40, 28, 51, 42, 109, 100] },
        { name: 'Download', data: [11, 32, 45, 32, 34, 52, 41] },
      ],
      xaxis: {
        type: 'datetime',
        categories: [
    ...
    },
    {
      ...
      series: [{ name: 'Weekly Revenue', data: [30, 110, 50, 40, 60, 90, 45] }],
