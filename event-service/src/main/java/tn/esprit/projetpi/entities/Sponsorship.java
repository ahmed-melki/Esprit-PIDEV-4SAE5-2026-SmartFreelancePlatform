...
@Entity
@Table(name = "sponsorships") // nom de la table
@Getter
@Setter
public class Sponsorship {
    ...
    @Column(name = "sponsor_id", nullable = true) // nullable = true → pas obligatoire
    private Long sponsorId; // reste Long, mais peut être null

    // 👇 Ajouter les champs du sponsor directement ici
