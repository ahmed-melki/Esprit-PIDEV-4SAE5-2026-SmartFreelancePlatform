...
import { ArticleFormComponent } from './features/blog/article-form/article-form.component';
...
export const routes: Routes = [
  ...
  { path: 'communication', loadChildren: () => import('./features/communication/communication.routes').then(m => m.routes) },
  // Marketing routes
  ...
  { path: 'blog/create', component: ArticleFormComponent },
  { path: 'blog/:id', component: ArticleDetailComponent },
  { path: 'blog/edit/:id', component: ArticleFormComponent },
  // Competence routes
